...
If you want a more real-world example, think about stacks and queues.
The behavior is different, which end does data come off of?
If you substitute one for another, it could confuse the client code!
